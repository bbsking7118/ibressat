...
class FirebaseRealDBHandler:
    """
    클래스입니다. 
    """
    def __init__(self):
        """
        FirebaseRealDBHandler __init__
        ...
        cred = credentials.Certificate("conf/bskiwoom-firebase-adminsdk-b6vv2-78f1a11912.json")
        firebase_admin.initialize_app(cred,{
            'databaseURL' : 'https://bskiwoom-default-rtdb.asia-southeast1.firebasedatabase.app'
        })
